 ...
 */
public class FTPSSource extends AbstractFtpFileSource<FTPFile> {
    ...
    public boolean connect() {
        ...
        try {
            ...
            if (!FTPReply.isPositiveCompletion(replyCode)) {
                ...
                LOGGER.error("Connect Failed due to FTPS, com.datacloudsec.bootstrap.server refused connection.");
