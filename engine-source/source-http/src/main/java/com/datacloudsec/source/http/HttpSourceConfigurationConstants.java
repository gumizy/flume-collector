...
public class HttpSourceConfigurationConstants {
    ...
    public static final String CONFIG_BIND = "host";

    public static final String DEFAULT_BIND = "0.0.0.0";

    public static final String DEFAULT_HANDLER = "com.datacloudsec.source.http.BlobHandler";

    public static final String CONTEXT_PATH = "/";

    public static final String SERVELT_PATH = "/";
