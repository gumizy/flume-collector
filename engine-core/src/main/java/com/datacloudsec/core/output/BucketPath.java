...
import com.datacloudsec.core.tools.Clock;
import com.datacloudsec.core.tools.SystemClock;
import com.datacloudsec.core.tools.TimestampRoundDownUtil;
...
//          LOG.warn("Tag " + matcher.group(2) + " not found");
                ...
                replacement = replaceShorthand(c, headers, timeZone, needRounding, unit, roundDown, useLocalTimeStamp, ts);
            }
