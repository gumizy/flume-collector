...
public enum SinkType implements ComponentWithClassName {
    ...
    LOGGER("com.datacloudsec.core.sink.LoggerSink"),

    FILE("com.datacloudsec.core.sink.RollingFileSink"),

    SYSLOG("com.datacloudsec.sink.syslog.SyslogSink"),

    KAFKA("com.datacloudsec.sink.kafka.KafkaSink");
